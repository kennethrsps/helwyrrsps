...
public class DungeonController extends Controller {
	...
	public void processIncommingHit(Hit hit, Entity target) {
		if (player.getPerkManager().dungeoneeringPower) {
			int damage = hit.getDamage();
			hit.setDamage((int) (damage + (0.1 * damage)));
		}
	...
	public void openDoor(WorldObject object) {
		...
		if (dungeon.enterRoom(player, roomReference.getX() + Utils.ROTATION_DIR_X[object.getRotation()],
