...
public class PreShareD extends Dialogue {
	...
	@Override
	public void start() {
		sendOptionsDialogue("Would you like to enable pre-share? [Warning: Expert Players Only!]", "What is pre-share?",
				"Yes.", "No.");
	}
	...
	public void run(int interfaceId, int componentId) {
		if (stage == -1) {
			if (componentId == OPTION_1) {
				sendDialogue(
						"Pre-share is the removal of key sharing which increases teamwork and dungeon difficulty.");
				stage = 1;
