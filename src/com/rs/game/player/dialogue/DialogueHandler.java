...
import com.rs.game.player.content.xmas.XmasDialogue;
...
public final class DialogueHandler {
	...
	String fileLoc = "bin/com/rs/game/player/dialogue/impl";
	String packageDir = "com.rs.game.player.dialogue.impl";
	try {
	    ...
	    handledDialogues.put("XmasDialogue",
	    		(Class<Dialogue>) Class.forName(XmasDialogue.class.getCanonicalName()));
	    Logger.log(handledDialogues.size()+" dialogues initiated..");
