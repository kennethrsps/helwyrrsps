...
public enum Pets {
	...
	//Shrimpy is a miniature version of Har-aken that can be unlocked as a pet from a Volcanic shard, 
	//which is obtained as a reward from killing Har-aken. The odds of receiving this item are 1 in 200
