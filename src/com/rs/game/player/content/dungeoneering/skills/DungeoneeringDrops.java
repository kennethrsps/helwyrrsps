...
public class DungeoneeringDrops {
	...
	public static final Drop[] RARE_DROP_TABLE = { new Drop(1623, 1, 1), new Drop(1621, 1, 1), new Drop(1619, 1, 1),
			new Drop(1617, 1, 1), new Drop(1453, 1, 1), new Drop(1462, 1, 1), new Drop(987, 1, 1), new Drop(985, 1, 1),
			new Drop(995, 250, 1200), new Drop(1247, 1, 1), new Drop(830, 5, 5), new Drop(1201, 1, 1),
			new Drop(1319, 1, 1), new Drop(1373, 1, 1), new Drop(2366, 1, 1), new Drop(1249, 1, 1),
			new Drop(1149, 1, 1), new Drop(563, 45, 45), new Drop(563, 5, 50), new Drop(561, 47, 77),
			new Drop(566, 20, 20), new Drop(565, 50, 50), new Drop(892, 150, 150), new Drop(443, 100, 100),
			new Drop(995, 250, 1200) // again
			, new Drop(1215, 1, 1), new Drop(892, 150, 500) // again
			, new Drop(9143, 200, 200), new Drop(533, 151, 500), new Drop(2999, 25, 250), new Drop(258, 33, 33),
			new Drop(3001, 30, 120), new Drop(270, 10, 100), new Drop(454, 150, 7500), new Drop(450, 150, 800),
			new Drop(7937, 100, 14500), new Drop(1441, 25, 35), new Drop(1443, 25, 36), new Drop(1444, 1, 1),
			new Drop(372, 125, 1000), new Drop(383, 250, 500), new Drop(5321, 3, 3), new Drop(1631, 1, 1),
			new Drop(1615, 1, 1), new Drop(1391, 200, 200), new Drop(574, 1000, 1000), new Drop(570, 1000, 1000),
			new Drop(451, 1, 100), new Drop(2362, 1450, 7000), new Drop(2364, 1, 150), new Drop(5315, 1, 50),
			new Drop(5316, 1, 6), new Drop(5289, 10, 10), new Drop(5304, 1, 31), new Drop(5300, 1, 1),
			new Drop(1516, 100, 4500), new Drop(21620, 4, 4), new Drop(9342, 150, 150), new Drop(1216, 50, 50),
			new Drop(20667, 1, 1), new Drop(6686, 250, 250) };

	private boolean acessRareTable;
	private Drop[][] drops;
	private Drop[][] gearRareDrops;

	public DungeoneeringDrops(boolean acessRareTable) {
	...
	public Drop getDrop(int rarity, double e) {
		if (rarity >= RARE) {
			if (gearRareDrops[rarity - RARE] != null && gearRareDrops[rarity - RARE].length != 0
