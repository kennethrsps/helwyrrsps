...
public enum PickPocketableNPC {
     ...
     * The rogues.
     */
    ROGUE(new short[] { 187, 2267, 2268, 2269 }, new byte[] { 32, 42, 52,
    ...
    DESERT_PHOENIX(new short[] {1911}, new byte[] { 25, 85}, new byte[] { 1, 80 }, 
    		26, 5, 10, new Item(4621), new Item(4621)),
    ...
    private PickPocketableNPC(short[] npcIds, byte[] thievingLevel,
	    byte[] agilityLevel, double experience, int stunTime, int stunDamage, Item... loot) {
		this.npcIds = npcIds;
