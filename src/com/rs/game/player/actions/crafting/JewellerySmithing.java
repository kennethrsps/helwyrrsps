					...
					player.getActionManager().setAction(new Action() {
						...
						public boolean process(Player player) {
							...
							if (player.getSkills().getLevel(Skills.CRAFTING) < level) {
								player.sendMessage("You need a Crafting level of "
										+ level + ".");
								return false;
						...
						public int processWithDelay(Player player) {
							...
							player.addItemsMade();
							player.sendMessage("You've successfully made jewellery; "
	...
	public static void ringTransformation(Player player, final int itemId) {
		...
		player.getActionManager().setAction(new Action() {
			...
			public boolean start(Player player) {
				...
				player.getGlobalPlayerUpdater().transformIntoNPC(transformationId);
