...
public final class NPCCombatDefinitionsL {
    ...
    public final static NPCCombatDefinitions DEFAULT_DEFINITION = 
    		new NPCCombatDefinitions(100, -1, -1, -1, 5, 1, 33, 0, NPCCombatDefinitions.MELEE, -1, -1, NPCCombatDefinitions.PASSIVE);
		...
		try {
		    ...
		    while (buffer.hasRemaining()) {
				...
				npcCombatDefinitions.put(npcId, new NPCCombatDefinitions(
					hitpoints, attackAnim, defenceAnim, deathAnim, attackDelay, deathDelay, respawnDelay, maxHit,
					attackStyle, attackGfx, attackProjectile, agressivenessType));
		    }
		    channel.close();
		    in.close();
		} catch (Throwable e) {
