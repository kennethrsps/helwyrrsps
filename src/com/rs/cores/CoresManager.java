...
public final class CoresManager {
    ...
    private static CoresManager instance;
    ...
    public static void init() {
		...
		slowExecutor = availableProcessors >= 6 ? Executors
			.newScheduledThreadPool(availableProcessors >= 12 ? 4 : 2, new SlowThreadFactory()) : Executors
	...
	public static CoresManager get() {
		if (instance == null)
			instance = new CoresManager();
		return instance;
	}
	...
	public CoresManager fastExecutor(Timer fastExecutor) {
	...
	public CoresManager slowExecuter(ScheduledExecutorService slowExecuter) {
		CoresManager.slowExecutor = slowExecuter;
		return this;
	}
}